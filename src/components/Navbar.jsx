  ...
  return (
    <nav className={`fixed top-0 w-full z-[100] flex justify-between items-center px-6 md:px-12 py-4 transition-all duration-500 ${
      ...
      <ul className="hidden md:flex space-x-10 font-bold uppercase text-[10px] tracking-[0.2em] text-white/80">
        <li onClick={() => scrollToSection('home')} className="hover:text-blue-400 cursor-pointer">Home</li>
        <li onClick={() => scrollToSection('projects')} className="hover:text-blue-400 cursor-pointer">Projects</li>
        <li onClick={() => scrollToSection('about')} className="hover:text-blue-400 cursor-pointer">About</li>
        <li onClick={() => scrollToSection('contact')} className="hover:text-blue-400 cursor-pointer">Contact</li>
      </ul>
      ...
      <div className="flex items-center space-x-4 md:space-x-6">
        ...
        <button 
          onClick={onAdminClick} // This opens the Login.jsx page
